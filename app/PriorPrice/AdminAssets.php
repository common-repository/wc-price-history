...
class AdminAssets {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'wc-price-history-export', WC_PRICE_HISTORY_PLUGIN_URL . 'assets/js/export.js', [ 'jquery' ], '2.1.3', true );

		wp_enqueue_script( 'wc-price-history-import', WC_PRICE_HISTORY_PLUGIN_URL . 'assets/js/import.js', [ 'jquery' ], '2.1.3', true );
